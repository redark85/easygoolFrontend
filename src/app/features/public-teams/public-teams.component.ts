...
export class PublicTeamsComponent implements OnInit, OnDestroy {
  ...
  private loadData(): void {
    ...
    console.log('🚀 Consumiendo API de Teams Summary con parámetros:');
    ...
    console.log(`   - URL completa: ${FIXTURE_GET_TOURNAMENT_TEAMS_SUMMARY_ENDPOINT}?PhaseId=${params.phaseId}&GroupId=${params.groupId}`);
